...
class MessageRepository {
    ...
    val messages = listOf(
        ...
        Message(text = "can we see each other some day?", from = "you", to = "me", sentAt = 1212121212),
        Message(text = "hi, i dont know if it is a good idea", from = "me", to = "you", sentAt = 129182182),
        ...
        Message(text = "let me the chance of apologize me", from = "you", to = "me", sentAt = 192871928192),
        Message(text = "please...", from = "you", to = "me", sentAt = 192871928192),
        Message(text = "ok... where?", from = "me", to = "you", sentAt = 1289128912),
        Message(text = "same place, you won't regret", from = "you", to = "me", sentAt = 192871928192),
        Message(text = "ok... when?", from = "me", to = "you", sentAt = 1289128912),
        Message(text = "tomorrow, after dinner, ok?", from = "you", to = "me", sentAt = 192871928192),
        Message(text = "ok, see u", from = "me", to = "you", sentAt = 1289128912),
        )
